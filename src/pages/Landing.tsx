      ...
      >
        ...
        >
          <svg width="18" height="18" viewBox="0 0 24 24" aria-hidden="true" focusable="false">
            <path fill="#EA4335" d="M12 10.2v3.9h5.5c-.2 1.2-.9 2.2-1.9 2.9v2.4h3.1c1.8-1.6 2.8-4 2.8-7s-1-5.4-2.8-7l-3.1 2.4c1 .7 1.7 1.7 1.9 2.9H12z" />
            <path fill="#34A853" d="M12 24c2.5 0 4.6-.8 6.1-2.2l-3.1-2.4c-.9.6-2 .9-3.1.9-2.4 0-4.5-1.6-5.2-3.8H3.5v2.4C5 21.8 8.2 24 12 24z" />
